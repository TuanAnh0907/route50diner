...
(function($) {
	...
	// $.data() info at https://docs.jquery.com/Internals/jQuery.data
	...
	$.jPlayer.prototype = {
			...
			if(this.config.usingFlash) {
				if(this._checkForFlash(8)) {
					if($.browser.msie) {
						...
						html_embed += ' type="application/x-shockwave-flash" pluginspage="https://www.macromedia.com/go/getflashplayer" />';
						this.element.html(html_embed);
					}

				} else {
					this.element.html("<p>Flash 8 or above is not installed. <a href='https://get.adobe.com/flashplayer'>Get Flash!</a></p>");
				}
			}
		...
		_checkForFlash: function (version){
			...
			// https://code.google.com/p/flashreplace/
