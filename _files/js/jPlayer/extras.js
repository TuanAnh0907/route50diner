$(function(){
		...
		var myPlayList = [
			{name:"The Twist",mp3:"/_files/js/jPlayer/thetwist.mp3"},
			{name:"Sitting on the Dock",mp3:"/_files/js/jPlayer/dock.mp3"},
			{name:"My Girl",mp3:"/_files/js/jPlayer/girl.mp3"},
			{name:"Sugar Pie",mp3:"/_files/js/jPlayer/sugar.mp3"}
		];
